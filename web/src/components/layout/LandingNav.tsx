...
export default function LandingNav() {
  ...
  const userInitial = (user?.firstName || user?.username || "A").charAt(0).toUpperCase();
    ...
    อยู่ราว 60px ของพวกนี้ย่อไม่ได้ (ปุ่มมีความกว้างขั้นต่ำของมันเอง) ตัวสลับ
    ภาษาซึ่งอยู่ท้ายสุดจึงทะลุออกไปนอกขอบมน
